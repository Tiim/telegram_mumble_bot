...
public final class ServerCallbackPrxHelper extends Ice.ObjectPrxHelperBase implements ServerCallbackPrx
{
     ...
     **/
    public void
    userTextMessage(User state, TextMessage message, java.util.Map<String, String> __ctx)
    {
        userTextMessage(state, message, __ctx, true);
    }

    private void
    userTextMessage(User state, TextMessage message, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        ...
        while(true)
        {
            ...
            try
            {
                __delBase = __getDelegate(false);
                _ServerCallbackDel __del = (_ServerCallbackDel)__delBase;
                __del.userTextMessage(state, message, __ctx);
                return;
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
