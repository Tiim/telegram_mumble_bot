...
public final class ServerPrxHelper extends Ice.ObjectPrxHelperBase implements ServerPrx
{
     ...
     **/
    public int
    effectivePermissions(int session, int channelid)
        throws InvalidChannelException,
               InvalidSecretException,
               InvalidSessionException,
               ServerBootedException
     ...
     **/
    public int
    effectivePermissions(int session, int channelid, java.util.Map<String, String> __ctx)
        throws InvalidChannelException,
               InvalidSecretException,
               InvalidSessionException,
               ServerBootedException
    ...
    private int
    effectivePermissions(int session, int channelid, java.util.Map<String, String> __ctx, boolean __explicitCtx)
        throws InvalidChannelException,
               InvalidSecretException,
               InvalidSessionException,
               ServerBootedException
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                __delBase = __getDelegate(false);
                _ServerDel __del = (_ServerDel)__delBase;
                return __del.effectivePermissions(session, channelid, __ctx);
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
                __cnt = __handleExceptionWrapperRelaxed(__delBase, __ex, null, __cnt);
