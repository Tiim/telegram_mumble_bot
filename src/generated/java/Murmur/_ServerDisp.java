...
public abstract class _ServerDisp extends Ice.ObjectImpl implements Server
{
     ...
     **/
    public final void
    effectivePermissions_async(AMD_Server_effectivePermissions __cb, int session, int channelid)
        throws InvalidChannelException,
               InvalidSecretException,
               InvalidSessionException,
               ServerBootedException
    ...
    public static Ice.DispatchStatus
    ___effectivePermissions(Server __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
